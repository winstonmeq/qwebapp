...
import { User, Shield, Trash2, RefreshCw, ArrowLeft } from 'lucide-react';
          ...
          <div className="flex items-center justify-between h-20">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm">User Management & System Administration</p>
              </div>
            </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-white rounded-xl p-6 shadow-lg">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-600 uppercase">Responders</p>
                <p className="text-3xl font-bold text-gray-900 mt-2">
                  ...
                  <tr key={user._id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <select
                        ...
                        className={`px-3 py-1 rounded-full text-xs font-semibold text-white ${getRoleBadge(user.role)}`}
                      >
